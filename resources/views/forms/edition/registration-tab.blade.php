...
<div class="w-full min-h-100">
    <div class="  grid grid-cols-1 sm:grid-cols-2 gap-4  mt-4  notHonorific">
        ...
        <span>
            ...
            <div   class="form-text">
            O desenvolvimento deverá conter no mínimo 100 palavras e no máximo 2000.
            </div>
        </span>
        ...
        <span>
            ...
            <div   class="form-text">
            O objetivo deverá conter no mínimo 100 palavras e no máximo 500.
            </div>
        </span>
    ...
    <div class="  grid grid-cols-1 sm:grid-cols-2 gap-4  mt-4  Honorific">
        ...
        <span>
            ...
            <div   class="form-text">
            O objetivo deverá conter no mínimo 100 palavras e no máximo 2000.
            </div>
         ...
         <span>
            ...
            <div   class="form-text">
            O objetivo deverá conter no mínimo 100 palavras e no máximo 1000.
            </div>
